...
# Per-rank log-normal length parameters, tuned so that first-fit-decreasing
# packing yields ~10 batches for rank 0 and ~13 for rank 1 under BASE_SEED.
# The imbalance emerges from the data distribution rather than from a
