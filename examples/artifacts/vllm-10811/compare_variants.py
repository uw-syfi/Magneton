...
The two sides of this comparison cannot share a process: the change is a source edit to
vllm/attention/backends/flash_attn.py, applied to the installed package.
So each is profiled by its own run, saved, and compared afterwards.

    python compare_variants.py --save before   # unpatched
    # apply the edit from README.md
