    ...
    for _ in range(NUM_PROMPTS):
        ...
        for _ in range(5):  # Max attempts to correct
            ...
            if diff > 0:
                ...
                # diff is negative here: drop that many tokens. Never all of
                # them -- decoding an empty list gives an empty prompt, which
                # the assertion below rightly refuses. How far a decode
                # overshoots depends on the tokenizer, so on some of them this
                # subtracts more than there is.
