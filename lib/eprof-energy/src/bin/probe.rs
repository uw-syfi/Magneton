...
//!
//! Samples every visible GPU for a window and prints per-device statistics.
//! When power numbers in a trace look wrong, this answers the first question --
//! whether NVML loads and reports sane values on this machine at all -- without
//! involving torch, CUDA or the rest of the profiler.
//!
//! Usage: `eprof-probe [duration_ms] [device_id ...]`
