    ...
    case CUPTI_CB_DOMAIN_RUNTIME_API:
      switch (cbid) {
        ...
        case CUPTI_RUNTIME_TRACE_CBID_cudaMemcpy_v3020:
          cblist =
              &callbacks_
                  .runtime[CUDA_MEMCPY - __RUNTIME_CB_DOMAIN_START];
          break;
        case CUPTI_RUNTIME_TRACE_CBID_cudaMemcpyAsync_v3020:
          cblist =
              &callbacks_
                  .runtime[CUDA_MEMCPY_ASYNC - __RUNTIME_CB_DOMAIN_START];
          break;
        default:
          break;
      }
    ...
    case CUPTI_CB_DOMAIN_DRIVER_API:
      switch (cbid) {
        case CUPTI_DRIVER_TRACE_CBID_cuLaunchKernel:
          cblist =
              &callbacks_
                  .runtime[CUDA_DRIVER_LAUNCH_KERNEL - __DRIVER_CB_DOMAIN_START];
          break;
        case CUPTI_DRIVER_TRACE_CBID_cuLaunchKernelEx:
          cblist =
              &callbacks_
                  .runtime[CUDA_DRIVER_LAUNCH_KERNEL_EX - __DRIVER_CB_DOMAIN_START];
          break;
        default:
          break;
      }
