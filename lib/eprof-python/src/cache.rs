...
/// Call kinds, in the order the tracer distinguishes them.
...
/// A resolved callsite, as post-processing needs it.
#[repr(C)]
pub struct SiteView {
    pub key: u64,
    pub event_type: i32,
...
pub struct PyCache {
    ...
    /// Interned sites, in intern order.
