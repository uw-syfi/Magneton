...
/// libkineto::ActivityType values this code needs to name.
mod kineto_type {
...
/// One node of the materialized tree, as the python bridge reads it.
#[repr(C)]
#[derive(Clone)]
...
impl EventArray {
    ...
    /// Puts the array in start-time order, which parenting depends on.
