...
// Everything here needs a c10::IValue or an at::RecordFunction in hand, which
// is the whole reason this file exists. What it produces is appended straight
// to the op's record through the wrappers below; how those values are formatted
// into a trace is decided later, in eprof-torch/src/inputs.rs.
