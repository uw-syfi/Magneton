...
namespace {
// The run's conversion from raw clock readings to trace time. Held here
// because the calibration object is c10's and the conversion has to outlive
// the state that made it -- kineto keeps calling it while it processes.
