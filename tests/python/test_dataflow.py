...
This test demonstrates the new pluggable architecture with dataflow recording,
both standalone and combined with replay.
"""
...
def test_dataflow_with_replay():
    ...
    try:
        ...
        # Verify that tensors were cloned (outputs should be preserved).
        # This matters when replay is enabled: without cloning, an in-place op
        # downstream would have overwritten what was recorded.
